...
def main():
    ...
    if uploaded_file:
        ...
        filter_title = ['citizenship', 'senior', 'lead', 'Sr', '.Net', 'Clearance',
                        'Secret', 'Manager', 'Mgr', 'US Citizen', 'Principal', 'Embedded', 'HVAC', 'Staff']
        ...
        column_order = ['id', 'Apply', 'title', 'company', 'location', 'job_url',
                        'similarity_score', 'date_posted', 'company_num_employees']
